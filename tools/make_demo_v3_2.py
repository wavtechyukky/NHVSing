...
<header>
  ...
  <p>V3.2 = V3.1 with the high-pitch <b>1-period dropout</b> ("歯抜け") fixed. The square overlap-add in the LTV filter let a frame's filtered spillover cancel a whole glottal period in anti-phase at high F0; V3.2 replaces it with a <b>Hann WOLA</b> (50% overlap) that tapers the spillover, and the ONNX export matches. Training also randomises the excitation start phase per batch and uses a higher-resolution multi-resolution STFT loss.</p>
  <p>
